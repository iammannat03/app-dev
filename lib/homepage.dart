...
import 'legal_info_model.dart';
export 'legal_info_model.dart';

class LegalInfoWidget extends StatefulWidget {
  const LegalInfoWidget({Key? key}) : super(key: key);

  @override
  _LegalInfoWidgetState createState() => _LegalInfoWidgetState();
}

class _LegalInfoWidgetState extends State<LegalInfoWidget> {
  late LegalInfoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => LegalInfoModel());
